                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo number_format($result->package_price_1y); ?> JD</td>
                                    <td><?php echo number_format($result->package_price_6m); ?> JD</td>
                                    <td><?php echo number_format($result->package_price_3m); ?> JD</td>
                                    <td><?php echo number_format($result->package_price_1m); ?> JD</td>
                                    <td><?php echo number_format($result->package_price_1week); ?> JD</td>
                                    <td>
                                    <a href="add-location-package.php?alpid=<?php echo htmlentities($result->package_id); ?>">Edit Location </a>|
